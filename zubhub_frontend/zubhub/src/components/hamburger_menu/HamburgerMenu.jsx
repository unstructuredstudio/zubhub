...
import styles from '../../assets/js/styles/components/hamburger_menu/hamburgerMenuStyles';
...
const HamburgerMenu = ({ setDropdownOpen, dropdownOpen }) => {
  ...
  return (
    <>
      <IconButton
        className={clsx(classes.hamburgerButtonStyle, common_classes.addOnSmallScreen)}
