...
function Projects(props) {
  ...
  const { loading } = state;
  const { results: projects } = props.projects.all_projects;
  ...
  if (loading) {
    ...
    return (
      <>
        ...
        <Box className={clsx(classes.sectionStyle, common_classes.backgroundWhite)}>
          {state.isMobileView ? (
            ''
          ) : (
            <Box
            ...
            >
              <img className={classes.desktopambassadorImageStyle} src={child} alt="" />
            </Box>
          )}
          <Box style={{ marginLeft: state.isMobileView ? '0' : '15em' }}>
            <br />
            <Typography className={classes.MessagePrimaryStyle}>{t('projects.child.title')}</Typography>
            <br />
            <br />
          ...
          {state.isMobileView ? (
            ...
            >
              <img className={classes.ambassadorImageStyle} src={child} alt="" />
            </Box>
          ) : (
            ''
          )}
        ...
        <Box className={clsx(classes.sectionStyle, common_classes.backgroundWhite)}>
          <Box>
            <br />
            <Typography className={classes.MessagePrimaryStyle}>{t('projects.teams.title')}</Typography>
            <br></br>
            <Typography className={classes.MessageSecondaryStyle}>{t('projects.teams.1')}</Typography>
            <br />
            <Typography className={classes.MessageSecondaryStyle}>{t('projects.teams.2')}</Typography>
            <CustomButton
              className={classes.heroButtonStyle}
              size="small"
              primaryButtonStyle
          ...
          {state.isMobileView ? (
            ...
            >
              <img className={classes.teamsImageStyle} src={teams} alt="" />
            </Box>
          ) : (
            <Box
              className={clsx(classes.teamsImageContainerStyle, {
              ...
              style={{ marginTop: state.isMobileView ? '0' : '4em' }}
            >
              <img className={classes.desktopteamsImageStyle} src={teams} alt="" />
            </Box>
          )}
        </Box>

        <Box
          className={classes.carouselSectionStyle}
          style={{
            ...
            <div className={classes.carouselSlide}>
              <Box className={classes.sectionStyle}>
                <Box className={classes.heroMessageContainerStyle} style={{ textAlign: 'left' }}>
                  <Typography className={classes.MessagePrimaryStyle}>{t('projects.reviews.title')}</Typography>
                  <Typography className={classes.heroMessageSecondaryStyle}>
                    {t('projects.reviews.1.review')}
                  </Typography>
                  <Typography className={classes.heroMessagePrimaryStyle}>{t('projects.reviews.1.name')}</Typography>
                  <Typography className={classes.MessageSecondaryStyle}>
            ...
            <div className={classes.carouselSlide} style={{ backgroundColor: '#00B8C4' }}>
              <Box className={classes.sectionStyle}>
                <Box className={classes.heroMessageContainerStyle} style={{ textAlign: 'left' }}>
                  ...
                  <Typography className={classes.heroMessagePrimaryStyle}>{t('projects.reviews.2.name')}</Typography>
                  <Typography className={classes.MessageSecondaryStyle}>
            ...
            <div className={classes.carouselSlide} style={{ backgroundColor: '#292535' }}>
              <Box className={classes.sectionStyle}>
                <Box className={classes.heroMessageContainerStyle} style={{ textAlign: 'left' }}>
                  ...
                  <Typography className={classes.heroMessagePrimaryStyle}>{t('projects.reviews.3.name')}</Typography>
                  <Typography className={classes.MessageSecondaryStyle}>
        ...
        <Box className={clsx(classes.sectionStyle, common_classes.backgroundWhite)}>
          <Box>
            <br />
            <Typography className={classes.MessagePrimaryStyle}>{t('projects.global.title')}</Typography>
            <br></br>
            <Typography className={classes.MessageSecondaryStyle}>{t('projects.global.body')}</Typography>
            <br />
            <Typography className={classes.MessageSecondaryStyle}>{t('projects.global.body2')}</Typography>
            <CustomButton
              className={classes.heroButtonStyle}
              size="small"
              primaryButtonStyle
          ...
          >
            <img className={classes.globalImageStyle} src={global} alt="" />
          </Box>
        </Box>
      </>
    );
