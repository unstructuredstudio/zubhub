          ...
          <Toolbar className={classes.toolBarStyle}>
            ...
            <div className={classes.navActionStyle}>
              {!props.auth.token ? (
                <>
                  <IconButton
                    className={clsx(classes.toggleSearchFormStyle, classes.addOn894)}
                    id="toggle-search"
                    aria-label="toggle search form"
                    onClick={() => handleSetState(handleToggleSearchForm(state))}
                  >
                    <SearchIcon />
                  </IconButton>
                  <Link className={clsx(classes.textDecorationNone, common_classes.removeOnSmallScreen)} to="/login">
                    <CustomButton variant="outlined" size="large" secondaryButtonStyle className={classes.customButton}>
                      {t('pageWrapper.navbar.login')}
                    </CustomButton>
                  </Link>
                  <Link className={clsx(classes.textDecorationNone, common_classes.removeOnSmallScreen)} to="/signup">
                    <CustomButton
                      variant="contained"
                      size="large"
                      primaryButtonStyle
                ...
                <>
                  {props.match.path === '/activities' ? (
                    props.auth.tags.filter(tag => tag === 'moderator' || tag === 'staff' || tag === 'educator').length >
                      0 && (
                      <Link
                        className={clsx(
                  ...
                  <Link
                    ...
                    to="/projects/create"
                  >
                    <CustomButton variant="contained" primaryButtonStyle className={classes.customButton} size="small">
                  ...
                  <NotificationButton
                    className={clsx(common_classes.marginRight1em, common_classes.removeOnSmallScreen)}
                  />
                  <Avatar
                  ...
                  >
                    ...
                    <MenuItem>
                      <Link className={classes.textDecorationNone} to="/profile">
                        <Typography variant="subtitle2" color="textPrimary" component="span">
                    ...
                    <MenuItem className={common_classes.addOnSmallScreen}>
                      <Link className={classes.textDecorationNone} to="/projects/create">
                        <Typography variant="subtitle2" color="textPrimary" component="span">
                          {t('pageWrapper.navbar.createProject')}
                        </Typography>
                      </Link>
                    </MenuItem>
                    {props.auth.tags.filter(tag => tag === 'staff' || tag === 'educator').length > 0 && (
                      <MenuItem
                    ...
                    {props.auth.tags.filter(tag => tag === 'staff' || tag === 'moderator').length > 0 && (
                      <MenuItem
                        className={clsx(common_classes.removeOnSmallScreen)}
                        onClick={() => {
                    ...
                    <MenuItem>
                      <Link className={classes.textDecorationNone} to={`/creators/${props.auth.username}/projects`}>
                        <Typography variant="subtitle2" color="textPrimary" component="span">
                    ...
                    <MenuItem>
                      <Link className={classes.textDecorationNone} to={`/creators/${props.auth.username}/followers`}>
                        <Typography variant="subtitle2" color="textPrimary" component="span">
                    ...
                    <MenuItem>
                      <Link className={classes.textDecorationNone} to={`/creators/${props.auth.username}/following`}>
                        <Typography variant="subtitle2" color="textPrimary" component="span">
                    ...
                    <MenuItem>
                      <Link className={classes.textDecorationNone} to="/projects/saved">
                        <Typography variant="subtitle2" color="textPrimary" component="span">
