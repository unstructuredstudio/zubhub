...
import styles from '../../assets/js/styles/views/edit_team/editTeamStyles';
...
function EditTeam(props) {
  ...
  const { tool_tip_open, open_delete_account_modal } = state;
  const { t } = props;
    ...
    <>
      ...
      >
        ...
        <DialogActions className={modal_classes.dialogActionsStyle}>
          ...
          <CustomButton
            variant="contained"
            onClick={() => handleSetState(deleteAccount(groupname, props, state))}
            primaryButtonStyle
            className={modal_classes.iconButton}
          >
...
const mapDispatchToProps = dispatch => ({
  getTeamProfile: args => dispatch(UserActions.getTeamProfile(args)),
  getAuthUser: props => dispatch(AuthActions.getAuthUser(props)),
  editTeam: props => dispatch(UserActions.editTeam(props)),
  deleteTeam: props => dispatch(UserActions.deleteTeam(props)),
  getLocations: () => dispatch(AuthActions.getLocations()),
