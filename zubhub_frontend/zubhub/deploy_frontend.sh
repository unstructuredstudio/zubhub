...
rm -rf zubhub_frontend/zubhub/.env.example
rm -rf zubhub_frontend/zubhub/Dockerfile
rm -rf zubhub_frontend/zubhub/docker-compose.yml
rm -rf zubhub_frontend/zubhub/nginx/dev
