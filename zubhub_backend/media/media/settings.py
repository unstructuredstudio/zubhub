...
DEFAULT_FRONTEND_PROTOCOL = os.environ.get("DEFAULT_FRONTEND_PROTOCOL", default="https")
DEFAULT_BACKEND_PROTOCOL = os.environ.get("DEFAULT_BACKEND_PROTOCOL", default="https")
DEBUG = int(os.environ.get("DEBUG", default=0))
STORE_MEDIA_LOCALLY = bool(int(os.environ.get("STORE_MEDIA_LOCALLY", default=1)))
